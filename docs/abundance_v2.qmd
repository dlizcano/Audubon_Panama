...
# new
parita_data_full <- read_excel("D:/AudubonPanama/data/all_records_audubon_panama_Darwin_Core_revision.xlsx", 
...
covs <- read_csv("D:/AudubonPanama/shp/sites_covs_parita_nona.csv")
...
######### precipitacion
precip_Anton <- read_csv("D:/AudubonPanama/data/Precip_Anton.csv")
...
fit_unm_spx_p <- unmarked::occuRN(~ prec ~1, data=umf_y_full_spx) # ok!
fit_unm_spx_h <- unmarked::occuRN(~ hour ~1, data=umf_y_full_spx) # ok!
...
Runs a loop on a list containing the of species.  
