---
title: "Abundance five species. Parita Bay, Panama"
...
# fit unmarked
fit_unm_sp2_0 <- unmarked::occuRN(~1~1, data=umf_y_full_2) # ok!
...
fit_unm_sp2_1 <- unmarked::occuRN(~1~scale(BGB_Spawn), data=umf_y_full_2)
fit_unm_sp2_2 <- unmarked::occuRN(~1~scale(human_foot), data=umf_y_full_2)
fit_unm_sp2_3 <- unmarked::occuRN(~1~scale(NDVI), data=umf_y_full_2) # ok!
fit_unm_sp2_4 <- unmarked::occuRN(~1~scale(river), data=umf_y_full_2)
fit_unm_sp2_4s <- unmarked::occuRN(~1~scale(I(river^2)), data=umf_y_full_2)
fit_unm_sp2_5 <- unmarked::occuRN(~1~scale(carbon), data=umf_y_full_2)
fit_unm_sp2_6 <- unmarked::occuRN(~1~scale(canopy), data=umf_y_full_2)
fit_unm_sp2_7 <- unmarked::occuRN(~1~scale(canopy)+
                                scale(BGB_Spawn), data=umf_y_full_2)
fit_unm_sp2_8 <- unmarked::occuRN(~1~scale(BGB_Spawn)+
                                  scale(human_foot), data=umf_y_full_2, 
                                starts=c(1,1,1,1), method = "BFGS",
                                control = list(maxit = 20000),
                                engine = "C")
fit_unm_sp2_9 <- unmarked::occuRN(~1~scale(canopy)+
                                  scale(BGB_Spawn)+
                                  scale(carbon)+
                                  scale(river)+
                                  scale(NDVI)+
...
fms2<-fitList("p(.) lambda(.)"=fit_unm_sp2_0,
...
summary(fit_unm_sp2_1) #### Null MODEL !!!!!!!!!!

# Empirical Bayes estimates of abundance at each site
re <- ranef(fit_unm_sp2_1)
plot(re)
print(re)
...
pred_psi <-predict(fit_unm_sp2_1, type="state", newdata=newdat_range, appendData=TRUE) 

###  Plot occupancy en escala original
plot(Predicted~BGB_Spawn, pred_psi,type="l",col="blue", ylim=c(0,80),
     xlab="canopy",
     ylab="Abundance RN")
...
occuPred <- terra::predict(newdata_terra, fit_unm_sp2_1, type="state", cores=3, na.rm=TRUE, progress = 'text')
...
levelplot(occuPred[[1]], par.settings = YlOrRdTheme(), margin=FALSE, main="Abundance")
...
# fit unmarked
fit_unm_sp3_0 <- unmarked::occuRN(~1~1, data=umf_y_full_3) # ok!
#fit_unm_sp2_0h <- unmarked::occu(~scale(hour)~1, data=umf_y_full_2) # It work!
# fit_unm_sp2_0c <- unmarked::occu(~scale(canopy)~1, data=umf_y_full_2) # It work!
fit_unm_sp3_1 <- unmarked::occuRN(~1~scale(BGB_Spawn), data=umf_y_full_3,  starts=c(1,1,1), method = "BFGS",
               control = list(maxit = 20000),
               engine = "C")

fit_unm_sp3_2 <- unmarked::occuRN(~1~scale(human_foot), data=umf_y_full_3)
fit_unm_sp3_3 <- unmarked::occuRN(~1~scale(NDVI), data=umf_y_full_3) # ok!
fit_unm_sp3_4 <- unmarked::occuRN(~1~scale(river), data=umf_y_full_3)
fit_unm_sp3_4s <- unmarked::occuRN(~1~scale(I(river^2)), data=umf_y_full_3)
fit_unm_sp3_5 <- unmarked::occuRN(~1~scale(carbon_stock), data=umf_y_full_3)
fit_unm_sp3_6 <- unmarked::occuRN(~1~scale(canopy), data=umf_y_full_3)
fit_unm_sp3_7 <- unmarked::occuRN(~1~scale(canopy)+
                                  scale(BGB_Spawn), data=umf_y_full_3)
fit_unm_sp3_8 <- unmarked::occuRN(~1~scale(BGB_Spawn)+
                                  scale(human_foot), data=umf_y_full_3, 
                                starts=c(1,1,1,1), method = "BFGS",
                                control = list(maxit = 20000),
                                engine = "C")
fit_unm_sp3_9 <- unmarked::occuRN(~1~scale(river)+ # non carbon
                                  scale(NDVI)+ 
                                  scale(human_foot), data=umf_y_full_3)
fit_unm_sp3_10 <- unmarked::occuRN(~1~scale(canopy)+ # all carbon
                                  scale(BGB_Spawn)+ 
                                  scale(carbon_stock), data=umf_y_full_3,
                                starts=c(1,1,1,1,1), method = "BFGS",
                                control = list(maxit = 20000),
                                engine = "C")
fit_unm_sp3_11 <- unmarked::occuRN(~1~scale(canopy)+
                                  scale(BGB_Spawn)+ 
                                  scale(carbon_stock)+
                                  scale(river)+ 
                                  scale(NDVI)+ 
...
# fit list for occupancy
fms3<-fitList("p(.) lambda(.)"=fit_unm_sp3_0,
              #"p(h) Ocu(.)"=fit_unm_sp2_0h, #,
              #"p(c) Ocu(.)"=fit_unm_sp2_0c,
              "p(.) lambda(BGB_Spawn)"=fit_unm_sp3_1,
              "p(.) lambda(human_foot)"=fit_unm_sp3_2,
              "p(.) lambda(NDVI)"=fit_unm_sp3_3,
              "p(.) lambda(river)"=fit_unm_sp3_4,
              #"p(.) Ocu(river^2)"=fit_unm_sp2_4s,
              "p() lambda(carbon)"=fit_unm_sp3_5,
              "p() lambda(canopy)"=fit_unm_sp3_6,
              "p() lambda(canopy+BGB_Spawn)"=fit_unm_sp3_7,
              "p() lambda(BGB_Spawn+human_foot)"=fit_unm_sp3_8,
              "p() lambda(river+NDVI+human_foot)"=fit_unm_sp3_9,
              "p() lambda(canopy+BGB_Spawn+carbon)"=fit_unm_sp3_10,
              "p() lambda(ALL)"=fit_unm_sp3_11
              )

# model selection detection unmarked
modSel(fms3)

summary(fit_unm_sp3_0)

pb_f <- parboot(fit_unm_sp3_0, nsim=500, report=10) 
plot (pb_f)


# Empirical Bayes estimates of abundance at each site
re <- ranef(fit_unm_sp3_0)
plot(re)
print(re)
...
# 
# 
# pred_psi <-predict(fit_unm_sp3_8, type="state", newdata=newdat_range, appendData=TRUE) 
# 
# ###  Plot occupancy en escala original
...
None because null model is lowest AIC.
...
# fit unmarked
fit_unm_sp4_0 <- unmarked::occuRN(~1~1, data=umf_y_full_4) # ok!
#fit_unm_sp2_0h <- unmarked::occu(~scale(hour)~1, data=umf_y_full_2) # It work!
# fit_unm_sp2_0c <- unmarked::occu(~scale(canopy)~1, data=umf_y_full_2) # It work!
fit_unm_sp4_1 <- unmarked::occuRN(~1~scale(BGB_Spawn), data=umf_y_full_4,  starts=c(1,1,1), method = "BFGS",
               control = list(maxit = 20000),
               engine = "C")

fit_unm_sp4_2 <- unmarked::occuRN(~1~scale(human_foot), data=umf_y_full_4)
fit_unm_sp4_3 <- unmarked::occuRN(~1~scale(NDVI), data=umf_y_full_4) # ok!
fit_unm_sp4_4 <- unmarked::occuRN(~1~scale(river), data=umf_y_full_4)
fit_unm_sp4_4s <- unmarked::occuRN(~1~scale(I(river^2)), data=umf_y_full_4)
fit_unm_sp4_5 <- unmarked::occuRN(~1~scale(carbon_stock), data=umf_y_full_4)
fit_unm_sp4_6 <- unmarked::occuRN(~1~scale(canopy), data=umf_y_full_4)
fit_unm_sp4_7 <- unmarked::occuRN(~1~scale(canopy)+
                                  scale(BGB_Spawn), data=umf_y_full_4)
fit_unm_sp4_8 <- unmarked::occuRN(~1~scale(BGB_Spawn)+
                                  scale(human_foot), data=umf_y_full_4, 
                                starts=c(1,1,1,1), method = "BFGS",
                                control = list(maxit = 20000),
                                engine = "C")
fit_unm_sp4_9 <- unmarked::occuRN(~1~scale(river)+ # non carbon
                                  scale(NDVI)+ 
                                  scale(human_foot), data=umf_y_full_4)
fit_unm_sp4_10 <- unmarked::occuRN(~1~scale(canopy)+ # all carbon
                                  scale(BGB_Spawn)+ 
                                  scale(carbon_stock), data=umf_y_full_4,
                                starts=c(1,1,1,1,1), method = "BFGS",
                                control = list(maxit = 20000),
                                engine = "C")
fit_unm_sp4_11 <- unmarked::occuRN(~1~scale(canopy)+
                                  scale(BGB_Spawn)+ 
                                  scale(carbon_stock)+
                                  scale(river)+ 
                                  scale(NDVI)+ 
...
# fit list for occupancy
fms4<-fitList("p(.) lambda(.)"=fit_unm_sp4_0,
              #"p(h) Ocu(.)"=fit_unm_sp2_0h, #,
              #"p(c) Ocu(.)"=fit_unm_sp2_0c,
              "p(.) lambda(BGB_Spawn)"=fit_unm_sp4_1,
              "p(.) lambda(human_foot)"=fit_unm_sp4_2,
              "p(.) lambda(NDVI)"=fit_unm_sp4_3,
              "p(.) lambda(river)"=fit_unm_sp4_4,
              #"p(.) Ocu(river^2)"=fit_unm_sp4_4s,
              "p() lambda(carbon)"=fit_unm_sp4_5,
              "p() lambda(canopy)"=fit_unm_sp4_6,
              "p() lambda(canopy+BGB_Spawn)"=fit_unm_sp4_7,
              "p() lambda(BGB_Spawn+human_foot)"=fit_unm_sp4_8,
              "p() lambda(river+NDVI+human_foot)"=fit_unm_sp4_9,
              "p() lambda(canopy+BGB_Spawn+carbon)"=fit_unm_sp4_10,
              "p() lambda(ALL)"=fit_unm_sp4_11
              )

# model selection detection unmarked
modSel(fms4)

summary(fit_unm_sp4_10)
...
pb_f <- parboot(fit_unm_sp4_10, nsim=500, report=10) 
plot (pb_f)
...
pred_psi <-predict(fit_unm_sp4_10, type="state", newdata=newdat_range, appendData=TRUE) 

###  Plot occupancy en escala original
plot(Predicted~BGB_Spawn, pred_psi,type="l",col="blue", ylim=c(0,84),
     xlab="BGB_Spawn",
     ylab="Abundance RN")
lines(lower~BGB_Spawn, pred_psi,type="l",col=gray(0.5))
lines(upper~BGB_Spawn, pred_psi,type="l",col=gray(0.5))
...
occuPred <- terra::predict(newdata_terra, fit_unm_sp4_10, type="state", cores=3, na.rm=TRUE, progress = 'text')
...
# fit unmarked
# fit unmarked
fit_unm_sp5_0 <- unmarked::occuRN(~1~1, data=umf_y_full_5) # ok!
#fit_unm_sp2_0h <- unmarked::occu(~scale(hour)~1, data=umf_y_full_2) # It work!
# fit_unm_sp2_0c <- unmarked::occu(~scale(canopy)~1, data=umf_y_full_2) # It work!
fit_unm_sp5_1 <- unmarked::occuRN(~1~scale(BGB_Spawn), data=umf_y_full_5,  starts=c(1,1,1), method = "BFGS",
               control = list(maxit = 20000),
               engine = "C")

fit_unm_sp5_2 <- unmarked::occuRN(~1~scale(human_foot), data=umf_y_full_5)
fit_unm_sp5_3 <- unmarked::occuRN(~1~scale(NDVI), data=umf_y_full_5) # ok!
fit_unm_sp5_4 <- unmarked::occuRN(~1~scale(river), data=umf_y_full_5)
fit_unm_sp5_4s <- unmarked::occuRN(~1~scale(I(river^2)), data=umf_y_full_5)
fit_unm_sp5_5 <- unmarked::occuRN(~1~scale(carbon_stock), data=umf_y_full_5)
fit_unm_sp5_6 <- unmarked::occuRN(~1~scale(canopy), data=umf_y_full_5)
fit_unm_sp5_7 <- unmarked::occuRN(~1~scale(canopy)+
                                  scale(BGB_Spawn), data=umf_y_full_5)
fit_unm_sp5_8 <- unmarked::occuRN(~1~scale(BGB_Spawn)+
                                  scale(human_foot), data=umf_y_full_5, 
                                starts=c(1,1,1,1), method = "BFGS",
                                control = list(maxit = 20000),
                                engine = "C")
fit_unm_sp5_9 <- unmarked::occuRN(~1~scale(river)+ # non carbon
                                  scale(NDVI)+ 
                                  scale(human_foot), data=umf_y_full_5)
fit_unm_sp5_10 <- unmarked::occuRN(~1~scale(canopy)+ # all carbon
                                  scale(BGB_Spawn)+ 
                                  scale(carbon_stock), data=umf_y_full_5,
                                starts=c(1,1,1,1,1), method = "BFGS",
                                control = list(maxit = 20000),
                                engine = "C")
fit_unm_sp5_11 <- unmarked::occuRN(~1~scale(canopy)+
                                  scale(BGB_Spawn)+ 
                                  scale(carbon_stock)+
                                  scale(river)+ 
                                  scale(NDVI)+ 
...
# fit list for occupancy
fms5<-fitList("p(.) lambda(.)"=fit_unm_sp5_0,
              #"p(h) Ocu(.)"=fit_unm_sp2_0h, #,
              #"p(c) Ocu(.)"=fit_unm_sp2_0c,
              "p(.) lambda(BGB_Spawn)"=fit_unm_sp5_1,
              "p(.) lambda(human_foot)"=fit_unm_sp5_2,
              "p(.) lambda(NDVI)"=fit_unm_sp5_3,
              "p(.) lambda(river)"=fit_unm_sp5_4,
              #"p(.) Ocu(river^2)"=fit_unm_sp4_4s,
              "p() lambda(carbon)"=fit_unm_sp5_5,
              "p() lambda(canopy)"=fit_unm_sp5_6,
              "p() lambda(canopy+BGB_Spawn)"=fit_unm_sp5_7,
              "p() lambda(BGB_Spawn+human_foot)"=fit_unm_sp5_8,
              "p() lambda(river+NDVI+human_foot)"=fit_unm_sp5_9,
              "p() lambda(canopy+BGB_Spawn+carbon)"=fit_unm_sp5_10,
              "p() lambda(ALL)"=fit_unm_sp5_11
              )

# model selection detection unmarked
modSel(fms5)

summary(fit_unm_sp5_11)

############# histogram evaluation
pb_f <- parboot(fit_unm_sp5_11, nsim=500, report=10) 
plot (pb_f)


pred_psi <-predict(fit_unm_sp5_11, type="state", newdata=newdat_range, appendData=TRUE) 

###  Plot occupancy en escala original
plot(Predicted~canopy, pred_psi,type="l",col="blue", ylim=c(0,14),
     xlab="canopy",
     ylab="Abundance RN")
...
###  Plot occupancy en escala original
plot(Predicted~BGB_Spawn, pred_psi,type="l",col="blue", ylim=c(0,14),
     xlab="BGB_Spawn",
     ylab="Abundance RN")
lines(lower~BGB_Spawn, pred_psi,type="l",col=gray(0.5))
lines(upper~BGB_Spawn, pred_psi,type="l",col=gray(0.5))
...
occuPred <- terra::predict(newdata_terra, fit_unm_sp5_11, type="state", cores=3, na.rm=TRUE, progress = 'text')
...
# fit unmarked
# fit unmarked
fit_unm_sp1_0 <- unmarked::occuRN(~1~1, data=umf_y_full_1) # ok!
#fit_unm_sp2_0h <- unmarked::occu(~scale(hour)~1, data=umf_y_full_2) # It work!
# fit_unm_sp2_0c <- unmarked::occu(~scale(canopy)~1, data=umf_y_full_2) # It work!
fit_unm_sp1_1 <- unmarked::occuRN(~1~scale(BGB_Spawn), data=umf_y_full_1,  starts=c(1,1,1), method = "BFGS",
               control = list(maxit = 20000),
               engine = "C")

fit_unm_sp1_2 <- unmarked::occuRN(~1~scale(human_foot), data=umf_y_full_1)
fit_unm_sp1_3 <- unmarked::occuRN(~1~scale(NDVI), data=umf_y_full_1) # ok!
fit_unm_sp1_4 <- unmarked::occuRN(~1~scale(river), data=umf_y_full_1)
fit_unm_sp1_4s <- unmarked::occuRN(~1~scale(I(river^2)), data=umf_y_full_1)
fit_unm_sp1_5 <- unmarked::occuRN(~1~scale(carbon_stock), data=umf_y_full_1)
fit_unm_sp1_6 <- unmarked::occuRN(~1~scale(canopy), data=umf_y_full_1)
fit_unm_sp1_7 <- unmarked::occuRN(~1~scale(canopy)+
                                  scale(BGB_Spawn), data=umf_y_full_1)
fit_unm_sp1_8 <- unmarked::occuRN(~1~scale(BGB_Spawn)+
                                  scale(human_foot), data=umf_y_full_1, 
                                starts=c(1,1,1,1), method = "BFGS",
                                control = list(maxit = 20000),
                                engine = "C")
fit_unm_sp1_9 <- unmarked::occuRN(~1~scale(river)+ # non carbon
                                  scale(NDVI)+ 
                                  scale(human_foot), data=umf_y_full_1)
fit_unm_sp1_10 <- unmarked::occuRN(~1~scale(canopy)+ # all carbon
                                  scale(BGB_Spawn)+ 
                                  scale(carbon_stock), data=umf_y_full_1,
                                starts=c(1,1,1,1,1), method = "BFGS",
                                control = list(maxit = 20000),
                                engine = "C")
fit_unm_sp1_11 <- unmarked::occuRN(~1~scale(canopy)+
                                  scale(BGB_Spawn)+ 
                                  scale(carbon_stock)+
                                  scale(river)+ 
                                  scale(NDVI)+ 
...
# fit list for occupancy
fms1<-fitList("p(.) lambda(.)"=fit_unm_sp1_0,
              #"p(h) Ocu(.)"=fit_unm_sp2_0h, #,
              #"p(c) Ocu(.)"=fit_unm_sp2_0c,
              "p(.) lambda(BGB_Spawn)"=fit_unm_sp1_1,
              "p(.) lambda(human_foot)"=fit_unm_sp1_2,
              "p(.) lambda(NDVI)"=fit_unm_sp1_3,
              "p(.) lambda(river)"=fit_unm_sp1_4,
              #"p(.) Ocu(river^2)"=fit_unm_sp4_4s,
              "p() lambda(carbon)"=fit_unm_sp1_5,
              "p() lambda(canopy)"=fit_unm_sp1_6,
              "p() lambda(canopy+BGB_Spawn)"=fit_unm_sp1_7,
              "p() lambda(BGB_Spawn+human_foot)"=fit_unm_sp1_8,
              "p() lambda(river+NDVI+human_foot)"=fit_unm_sp1_9,
              "p() lambda(canopy+BGB_Spawn+carbon)"=fit_unm_sp1_10,
              "p() lambda(ALL)"=fit_unm_sp1_11
              )

# model selection detection unmarked
modSel(fms1)

summary(fit_unm_sp1_3)

############# histogram evaluation
pb_f <- parboot(fit_unm_sp1_3, nsim=500, report=10) 
plot (pb_f)


pred_psi <-predict(fit_unm_sp1_3, type="state", newdata=newdat_range, appendData=TRUE) 


###  Plot occupancy en escala original
plot(Predicted~NDVI, pred_psi,type="l",col="blue", ylim=c(0,97),
     xlab="NDVI",
     ylab="Abundance RN")
lines(lower~NDVI, pred_psi,type="l",col=gray(0.5))
lines(upper~NDVI, pred_psi,type="l",col=gray(0.5))
...
occuPred <- terra::predict(newdata_terra, fit_unm_sp1_3, type="state", cores=3, na.rm=TRUE, progress = 'text')
